...
11. ### What is a first class function
    ...
    For example, in Javascript, a function can be **passed as an argument** to other functions,
    ...
    ```javascript
    function firstClassFunction(parameterFunction) {
      parameterFunction();
      const variable = function () {
        console.log("Returning fun as variable");
      };
      return variable;
    }

    const returnValue = firstClassFunction(() =>
      console.log("Passing fun as Argument")
    );
...
20. ### How do you redeclare variables in switch block without an error
    ...
    switch (counter) {
      ...
      case 1:
        let name; // SyntaxError for re-declaration.
        break;
    }
    ```
    ...
    switch (counter) {
      ...
      case 1: {
        let name = "AMD"; // No SyntaxError for re-declaration.
        console.log(name);
        break;
      }
    }
...
27. ### What are closures
    ...
    1. we can use private variables and methods using closures.
